  ...
  rules: {
    ...
    * list, while permitting multiple internal commas and an optional trailing one */
    ...
    variable_declaration: $ => prec.left(TERMPREC.QUESTION_MARK + 1,
      seq(
        choice('my', 'state', 'our', GUARDED_KW($, 'field', 'class')),
        choice(
    ...
    _keywords: $ => choice($._postfixables, 'else', 'elsif', 'do', 'eval', 'our', 'state', 'my', 'local', 'require', 'return', 'eq', 'ne', 'lt', 'le', 'ge', 'gt', 'cmp', 'isa', 'try', 'catch', 'finally', 'defer', $._KW_USE, $._LOOPEX, $._PHASE_NAME, '__DATA__', '__END__', 'sub', $._map_grep, 'sort'),
